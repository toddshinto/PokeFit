...
COPY public.pokemon (pokemon_id, name, type, type_secondary, sprite_front_default, sprite_back_default, sprite_front_shiny, sprite_back_shiny, height, weight, habitat, flavor_text, flavor_text_new, growth_rate, species, capture_rate) FROM stdin;
